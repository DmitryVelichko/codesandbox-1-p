      ...
      <div className='about__container container grid'>
        ...
        <div className='about__data'>
          ...
          <p className='about__description'>
            ...
            <div className='about-animation'><a href='https://habr.com/ru/users/Dmitry_Velichko/articles/' rel='noreferrer' target='_blank' className='art__link'><i class="uil uil-notes"></i>    Articles on programming</a></div>
